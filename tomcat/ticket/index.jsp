...
<%
    ...
    Vector<Client> list=new Client().get_Tab(new Client().select(lo));
...
<div style="text-align: center;">
    ...
    <%
        for(int i=0;i<list.size();i++)
        {
            %>
            <h3>
                <a href="event.jsp?client=<% out.print(list.get(i).getId()); %>" style="text-decoration: none;"><% out.print(list.get(i).getNom()); %></a>
            </h3>
            <%
        }
        lo.close();
