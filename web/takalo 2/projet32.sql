...
insert into proposition values(null,1,1,10,2);
insert into proposition values(null,2,1,11,2);
create view all_element as (select o.id_objet,id_prop,titre,descriptions,prix,photo from objet o join photo p on photo=p.photo where o.id_objet=p.id_objet);