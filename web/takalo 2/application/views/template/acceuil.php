            ...
            for($i=0;$i<count($list_objet);$i++)
            {
                ...
                <div class="col-lg-2" class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><a href="../GestionProposition/redirect?objet=<?php echo($list_objet[$i]['id']) ?>" style="text-decoration: none;"><button class="form-control form-control-dark text-bg-dark">Echanger</button></a></p>
                    </div>
                </div>
                <br>
                <?php
