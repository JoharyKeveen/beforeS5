...
public class Util {
    public static Connection getConnection() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException{
        ...
        System.out.println("Class charged");
        Connection connectionSql = DriverManager.getConnection("jdbc:sqlserver://P14A-90-Tolotra\\SQLEXPRESS:1515;databasename=mine;integratedSecurity=True;trustServerCertificate=true");   
