...
public class Panel extends JPanel
{
    ...
    int wall;
    int x_exit, y_exit;
    public JButton get_automatique()
    {
    ...
    public void liberer_chemin_automatique()
    {
        for(int x=0;x<x_max;x++)
        {
            for(int y=0;y<y_max;y++)
            {
                if(this.cases[x][y]==666)
                {
                    this.cases[x][y]=0;
                }
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Panel()
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.all_player[0]=new Player(0,0,"Player 1");
        this.all_player[1]=new Player(2*this.measure,4*this.measure,"Player 2");
        this.all_player[2]=new Player(5*this.measure,2*this.measure,"Player 3");
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        this.x_exit=x*this.measure;
        this.y_exit=y*this.measure;
    }
