...
public class Key implements KeyListener
{
    ...
    public void keyPressed(KeyEvent e)
    {
        ...
        {
            if(panel.get_player().get_x_player()<panel.get_x_exit()&&panel.get_cases((panel.get_player().get_x_player()+panel.get_measure())/30,panel.get_player().get_y_player()/30)==0)
            {
                panel.liberer_chemin();
                panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,3);
                panel.get_player().set_coord(panel.get_player().get_x_player()+panel.get_measure(),panel.get_player().get_y_player());
            ...
            else if(panel.get_player().get_x_player()>panel.get_x_exit()&&panel.get_cases((panel.get_player().get_x_player()-panel.get_measure())/30,panel.get_player().get_y_player()/30)==0)
            {
                panel.liberer_chemin();
                panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,3);
                panel.get_player().set_coord(panel.get_player().get_x_player()-panel.get_measure(),panel.get_player().get_y_player());
            ...
            else if(panel.get_player().get_y_player()<panel.get_y_exit()&&panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()+panel.get_measure())/30)==0)
            {
                panel.liberer_chemin();
                panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,3);
                panel.get_player().set_coord(panel.get_player().get_x_player(),panel.get_player().get_y_player()+panel.get_measure());
