    ...
    public void keyPressed(KeyEvent e)
    {
        ...
        else if(e.getKeyCode()==12)
        {
            ...
            if(retest!=0)
            {
                if(panel.get_player().get_y_player()<=panel.get_y_exit())
                {
                    if(panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()+panel.get_measure())/30)==0||panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()+panel.get_measure())/30)==666||panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()+panel.get_measure())/30)==3)
                    {
                        panel.liberer_chemin_automatique();
                        panel.liberer_chemin();
                        panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,666);
                ...
                if(panel.get_player().get_x_player()<=panel.get_x_exit())
                {
                    if(panel.get_cases((panel.get_player().get_x_player()+panel.get_measure())/30,(panel.get_player().get_y_player())/30)==0||panel.get_cases((panel.get_player().get_x_player()+panel.get_measure())/30,(panel.get_player().get_y_player())/30)==666||panel.get_cases((panel.get_player().get_x_player()+panel.get_measure())/30,(panel.get_player().get_y_player())/30)==3)
                    {
                        panel.liberer_chemin_automatique();
                        panel.liberer_chemin();
                        panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,666);
                ...
                if(panel.get_player().get_y_player()>=panel.get_y_exit())
                {
                    if(panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()-panel.get_measure())/30)==0||panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()-panel.get_measure())/30)==3||panel.get_cases(panel.get_player().get_x_player()/30,(panel.get_player().get_y_player()-panel.get_measure())/30)==666)
                    {
                        panel.liberer_chemin_automatique();
                        panel.liberer_chemin();
                        panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,666);
                ...
                if(panel.get_player().get_x_player()>=panel.get_x_exit())
                {
                    if(panel.get_cases((panel.get_player().get_x_player()-panel.get_measure())/30,(panel.get_player().get_y_player())/30)==0||panel.get_cases((panel.get_player().get_x_player()-panel.get_measure())/30,(panel.get_player().get_y_player())/30)==3||panel.get_cases((panel.get_player().get_x_player()-panel.get_measure())/30,(panel.get_player().get_y_player())/30)==666)
                    {
                        panel.liberer_chemin_automatique();
                        panel.liberer_chemin();
                        panel.set_cases(panel.get_player().get_x_player()/30,panel.get_player().get_y_player()/30,666);
