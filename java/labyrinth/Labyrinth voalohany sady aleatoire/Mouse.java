...
public class Mouse implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            if(panel.get_cases(panel.get_player2().get_x_player()/30,(panel.get_player2().get_y_player()-panel.get_measure())/30)!=1)
            {
        ...
        {
            if(panel.get_cases((panel.get_player2().get_x_player()+panel.get_measure())/30,panel.get_player2().get_y_player()/30)!=1)
            {
